...
class TagTableMap extends TableMap
{
    ...
    /**
     * the column name for the tag_pk field
     */
    const COL_TAG_PK = 'tag.tag_pk';

    /**
     * the column name for the tag_name field
     */
    const COL_TAG_NAME = 'tag.tag_name';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('TagPk', 'TagName', ),
        self::TYPE_CAMELNAME     => array('tagPk', 'tagName', ),
        self::TYPE_COLNAME       => array(TagTableMap::COL_TAG_PK, TagTableMap::COL_TAG_NAME, ),
        self::TYPE_FIELDNAME     => array('tag_pk', 'tag_name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('TagPk' => 0, 'TagName' => 1, ),
        self::TYPE_CAMELNAME     => array('tagPk' => 0, 'tagName' => 1, ),
        self::TYPE_COLNAME       => array(TagTableMap::COL_TAG_PK => 0, TagTableMap::COL_TAG_NAME => 1, ),
        self::TYPE_FIELDNAME     => array('tag_pk' => 0, 'tag_name' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setPrimaryKeyMethodInfo('tag_tag_pk_seq');
        // columns
        $this->addPrimaryKey('tag_pk', 'TagPk', 'INTEGER', true, null, null);
        $this->addColumn('tag_name', 'TagName', 'VARCHAR', false, null, null);
    } // initialize()
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('TagPk', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('TagPk', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('TagPk', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('TagPk', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('TagPk', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('TagPk', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        return (int) $row[
            $indexType == TableMap::TYPE_NUM
                ? 0 + $offset
                : self::translateFieldName('TagPk', TableMap::TYPE_PHPNAME, $indexType)
        ];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(TagTableMap::COL_TAG_PK);
            $criteria->addSelectColumn(TagTableMap::COL_TAG_NAME);
        } else {
            $criteria->addSelectColumn($alias . '.tag_pk');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(TagTableMap::COL_TAG_PK, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(TagTableMap::COL_TAG_PK) && $criteria->keyContainsValue(TagTableMap::COL_TAG_PK) ) {
