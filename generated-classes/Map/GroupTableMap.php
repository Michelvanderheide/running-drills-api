...
class GroupTableMap extends TableMap
{
    ...
    /**
     * the column name for the group_pk field
     */
    const COL_GROUP_PK = 'group.group_pk';

    /**
     * the column name for the group_name field
     */
    const COL_GROUP_NAME = 'group.group_name';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('GroupPk', 'GroupName', ),
        self::TYPE_CAMELNAME     => array('groupPk', 'groupName', ),
        self::TYPE_COLNAME       => array(GroupTableMap::COL_GROUP_PK, GroupTableMap::COL_GROUP_NAME, ),
        self::TYPE_FIELDNAME     => array('group_pk', 'group_name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('GroupPk' => 0, 'GroupName' => 1, ),
        self::TYPE_CAMELNAME     => array('groupPk' => 0, 'groupName' => 1, ),
        self::TYPE_COLNAME       => array(GroupTableMap::COL_GROUP_PK => 0, GroupTableMap::COL_GROUP_NAME => 1, ),
        self::TYPE_FIELDNAME     => array('group_pk' => 0, 'group_name' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setPrimaryKeyMethodInfo('group_group_pk_seq');
        // columns
        $this->addPrimaryKey('group_pk', 'GroupPk', 'INTEGER', true, null, null);
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('GroupPk', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('GroupPk', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('GroupPk', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('GroupPk', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('GroupPk', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(GroupTableMap::COL_GROUP_PK);
            $criteria->addSelectColumn(GroupTableMap::COL_GROUP_NAME);
        } else {
            $criteria->addSelectColumn($alias . '.group_pk');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(GroupTableMap::COL_GROUP_PK, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(GroupTableMap::COL_GROUP_PK) && $criteria->keyContainsValue(GroupTableMap::COL_GROUP_PK) ) {
