 ...
 *
 *
 * @method     ChildUserQuery orderByUserPk($order = Criteria::ASC) Order by the user_pk column
 * @method     ChildUserQuery orderByGuid($order = Criteria::ASC) Order by the guid column
 ...
 * @method     ChildUserQuery orderByIsRemoved($order = Criteria::ASC) Order by the is_removed column
 *
 * @method     ChildUserQuery groupByUserPk() Group by the user_pk column
 * @method     ChildUserQuery groupByGuid() Group by the guid column
 ...
 * @method     ChildUserQuery groupByIsRemoved() Group by the is_removed column
 *
 ...
 *
 * @method     ChildUserQuery leftJoinUserGroupMapping($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserGroupMapping relation
 * @method     ChildUserQuery rightJoinUserGroupMapping($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserGroupMapping relation
 * @method     ChildUserQuery innerJoinUserGroupMapping($relationAlias = null) Adds a INNER JOIN clause to the query using the UserGroupMapping relation
 *
 * @method     ChildUserQuery joinWithUserGroupMapping($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the UserGroupMapping relation
 *
 * @method     ChildUserQuery leftJoinWithUserGroupMapping() Adds a LEFT JOIN clause and with to the query using the UserGroupMapping relation
 * @method     ChildUserQuery rightJoinWithUserGroupMapping() Adds a RIGHT JOIN clause and with to the query using the UserGroupMapping relation
 * @method     ChildUserQuery innerJoinWithUserGroupMapping() Adds a INNER JOIN clause and with to the query using the UserGroupMapping relation
 *
 ...
 *
 * @method     ChildUser findOneByUserPk(int $user_pk) Return the first ChildUser filtered by the user_pk column
 * @method     ChildUser findOneByGuid(string $guid) Return the first ChildUser filtered by the guid column
 ...
 * @method     ChildUser findOneByIsRemoved(boolean $is_removed) Return the first ChildUser filtered by the is_removed column *

 * @method     ChildUser requirePk($key, ConnectionInterface $con = null) Return the ChildUser by primary key and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUser requireOne(ConnectionInterface $con = null) Return the first ChildUser matching the query and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildUser requireOneByUserPk(int $user_pk) Return the first ChildUser filtered by the user_pk column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUser requireOneByGuid(string $guid) Return the first ChildUser filtered by the guid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildUser requireOneByIsRemoved(boolean $is_removed) Return the first ChildUser filtered by the is_removed column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildUser[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildUser objects based on current ModelCriteria
 * @method     ChildUser[]|ObjectCollection findByUserPk(int $user_pk) Return ChildUser objects filtered by the user_pk column
 * @method     ChildUser[]|ObjectCollection findByGuid(string $guid) Return ChildUser objects filtered by the guid column
 ...
 * @method     ChildUser[]|ObjectCollection findByIsRemoved(boolean $is_removed) Return ChildUser objects filtered by the is_removed column
...
abstract class UserQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'runningdrills', $modelName = '\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT user_pk, guid, user_name, user_email, user_password, is_removed FROM user WHERE user_pk = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_USER_PK, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_USER_PK, $keys, Criteria::IN);
    }

    /**
     * Filter the query on the user_pk column
     *
     * Example usage:
     * <code>
     * $query->filterByUserPk(1234); // WHERE user_pk = 1234
     * $query->filterByUserPk(array(12, 34)); // WHERE user_pk IN (12, 34)
     * $query->filterByUserPk(array('min' => 12)); // WHERE user_pk > 12
     * </code>
     *
     ...
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function filterByUserPk($userPk = null, $comparison = null)
    {
        if (is_array($userPk)) {
            $useMinMax = false;
            if (isset($userPk['min'])) {
                $this->addUsingAlias(UserTableMap::COL_USER_PK, $userPk['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($userPk['max'])) {
                $this->addUsingAlias(UserTableMap::COL_USER_PK, $userPk['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserTableMap::COL_USER_PK, $userPk, $comparison);
    }
    ...
    public function filterByGuid($guid = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_GUID, $guid, $comparison);
    }
    ...
    public function filterByIsRemoved($isRemoved = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_IS_REMOVED, $isRemoved, $comparison);
    }
    ...
    public function filterByUserGroupMapping($userGroupMapping, $comparison = null)
    {
        if ($userGroupMapping instanceof \UserGroupMapping) {
            return $this
                ->addUsingAlias(UserTableMap::COL_USER_PK, $userGroupMapping->getUserFk(), $comparison);
    ...
    {
        if ($user) {
            $this->addUsingAlias(UserTableMap::COL_USER_PK, $user->getUserPk(), Criteria::NOT_EQUAL);
        }
